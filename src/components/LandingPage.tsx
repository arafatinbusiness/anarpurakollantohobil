    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-emerald-500 selection:text-black overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-end p-6 sm:p-12 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/sompritir-bondhon-bg.jpg" 
            alt="Sompritir Bondhon Community" 
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            <div className="max-w-3xl space-y-4">
              ...
              >
                "সম্প্রীতির বন্ধন - একসাথে বাঁধা, একসাথে গড়া"
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                যেখানে প্রতিটি সম্পর্ক মূল্যবান, প্রতিটি মুহূর্ত স্মরণীয়
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                আমাদের সম্প্রদায়ের শক্তি আমাদের ঐক্যের মধ্যে
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              { 
                ...
                img: "/images/sompritir-bondhon-bg.jpg"
              },
              { 
                step: "০২", 
                title: "টাকা জমা", 
